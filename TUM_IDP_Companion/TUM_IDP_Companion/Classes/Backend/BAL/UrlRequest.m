...
- (NSURLRequest*)urlRequestForPostURL:(NSURL*)url withPayLoad:(NSData*)data {
    
    return  [self urlRequestForPostURL:url withPayLoad:data withRequestContentType:RequestContentTypeJSON];
}
...
- (NSURLRequest*)urlRequestForURL:(NSURL*)url httpMethodType:(HTTPMethodType)httpMethodType withPayLoad:(NSData*)data {
    ...
    if (httpMethodType == HTTPMethodTypePOST) {
        [self urlRequestForPostURL:url withPayLoad:data];
